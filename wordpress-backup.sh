...
wp_upload_folder="/var/www/html/wp-content/themes"
...
backup_folder_path="/root/wp_backup"
...
# offsite uplload for both files
scp $backup_folder_path/$wpfiles_backup_name login@123.456.789.10:/path/to/backup/
scp $backup_folder_path/$db_backup_name login@123.456.789.10:/path/to/backup/
